...
var Input = require('components/selectfield/AutosizeInput');
var classes = require('classnames');
var Value = require('components/selectfield/Value');
    ...
    render: function() {
        ...
        return (
            <div ref="wrapper" className={selectClass}>
                ...
                <div className="form-control Select-control" ref="control" onKeyDown={this.handleKeyDown} onMouseDown={this.handleMouseDown} onTouchEnd={this.handleMouseDown}>
                    {value}
					{input}
